...
- [x] 01-07-PLAN.md - LICENSE (MIT), NOTICE (upstream credit, lore exclusion), lore headers, CCRUG README, npm launch config (wave 4)
- [x] 01-08-PLAN.md - check-repo guard, user-approved git mutations (untrack dist/demo.mov, origin -> upstream + new origin foGledenalzi/CCRUGen (no push)), full verify gate, licensing confirmation (wave 5; Tasks 1-2 done and verify green, Task 3 licensing confirmed by the user on 2026-09-25 at the plan 01-08 Task 3 checkpoint (LICENSE holder `foGledenalzi`, NOTICE scope right as written))
