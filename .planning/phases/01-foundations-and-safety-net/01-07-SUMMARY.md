...
- **Task 1 (bc2a832), LICENSE, NOTICE, lore headers:**
  - `LICENSE` is the canonical MIT text, `Copyright (c) 2026 foGledenalzi` (D-02 default chosen by Claude; NOT yet confirmed by the user, that confirmation is the plan 01-08 Task 3 checkpoint).
